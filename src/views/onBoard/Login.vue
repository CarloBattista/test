            ...
            <section class="w-full md:w-2/4 h-full">
                <div class="w-full h-full px-[6%] md:px-[15%] flex flex-col justify-center">
                    <div class="flex gap-4 flex-col mb-8">
                        <h2 class="text-black text-3xl font-normal">Ciao, <span class="font-semibold">Bentornato!</span>
                        </h2>
                        <p class="text-black/60 text-sm font-normal">Siamo felici di rivederti.</p>
                    ...
                    <form @submit.prevent class="w-full flex gap-6 flex-col">
                        ...
                        <div class="w-full flex gap-1 flex-col">
                            ...
                            <p class="w-full mt-2 px-2 text-sm text-black/50 font-normal">{{ error.password }}</p>
                            <RouterLink to="/forgot-password"
                                class="w-full flex items-center justify-end text-sm font-medium hover:underline">Hai
                                dimenticato la password?</RouterLink>
                        </div>
                        <div class="w-full">
                            <ButtonForm @click="actionLogin" :disabled="false" :loading="loading" label="Accedi" />
                            <p class="w-full flex gap-1 mt-4 items-center justify-center text-sm font-normal">Non hai
                                ancora un account? <RouterLink to="/register" class="font-medium hover:underline">
